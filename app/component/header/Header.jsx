                        ...
                        <div className={s.boxMenuWrapper} id='boxManu'>
                            <div className={s.dropdown}>
                                ...
                                <div className={s.dropdown_content}>
                                    <Link href="/contactless-self-service-car-washes" id='mozhna'>{t("header4")}</Link>
                                    <Link href="/self-service-car-wash" id='mozhna'>{t("header5")}</Link>
                                    <Link href="/washing-technique" id='mozhna'>{t("header6")}</Link>
                                    <Link href="/constructions-of-car-washes" id='mozhna'>{t("header7")}</Link>
                                </div>
                            </div>
                            <div className={s.dropdown}>
                                <button>
                                ...
                                <div className={s.dropdown_content}>
                                    <Link href="/chemistry" id='mozhna'>{t("header9")}</Link>
                            ...
                            <div className={s.dropdown}>
                                ...
                                <div className={s.dropdown_content}>
                                    <Link href="/modernizations-and-expansions" id='mozhna'>{t("header24")}</Link>
                                    <Link href="/fiscalization" id='mozhna'>{t("header25")}</Link>
                                    <Link href="/service" id='mozhna'>{t("header26")}</Link>
